...
class UserCubit extends Cubit<UserState> {
  ...
  void signIn({
    ...
    try {
      ...
      emit(UserErrorState('An unexpected error occurred: ${ex.toString()}'));
    }
  }
 ...
 void _handleDioError(DioException e) {
  ...
  switch (e.type) {
    ...
    case DioExceptionType.badCertificate:
      errorMessage = 'Bad Certificate: ${e.message}';
      break;
    case DioExceptionType.unknown:
      errorMessage = 'Unknown Error: ${e.message}';
      break;
    default:
      errorMessage = 'Unhandled DioErrorType: ${e.type}, ${e.message}';
      break;
  }
